    ...
    >
      ...
      <div className="flex justify-center">
        <Image
          ...
          width={700}
          height={800}
          className="rounded-full w-full max-w-[300px] md:max-w-[700px] md:w-[400px] transition-all duration-500 ease-in-out hover:-translate-y-3 hover:shadow-lg"
        />
      </div>
        ...
        <ul className="grid gap-4 sm:grid-cols-2 text-gray-700 w-full">
          {beneficios.map((b, i) => (
            <motion.li
              ...
              viewport={{ once: false, amount: 0.5 }}
              className="bg-card text-other font-normal text-4xs tracking-text py-3 px-5 rounded-[20px] shadow-sm"
            >
              {b}
            </motion.li>
          ))}
